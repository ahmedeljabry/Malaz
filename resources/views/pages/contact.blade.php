...
@section('content')
        ...
        <div class="container">
            ...
            <h3 class="title mb-3 "  data-entrance="from-left">
                {{ __('nav.contact') }}
            </h3>

          <div class="row">
              <div class="col-xl-6">
                  <div style="border-radius:20px; overflow:hidden;" data-entrance="from-left">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8828.338198583187!2d39.18138550046487!3d21.51324324359736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3d01fb1137e59%3A0xe059579737b118db!2sJeddah%20Saudi%20Arabia!5e0!3m2!1sen!2seg!4v1759687803016!5m2!1sen!2seg" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  </div>

                  <div class="row mt-5 mb-5">
                      <div class="col-xl-6" data-entrance="from-left">
                          <h5 class="bold mb-4">Location</h5>
                          <p>Riyadh: Al Olaya, King Fahd Road</p>
                          <p>Jeddah: Al Sharafiyah – Khalid Bin Al-Walid Street</p>
                      </div>
                      <div class="col-xl-6" data-entrance="from-bottom">
                          <h5 class="bold mb-4">Call us</h5>
                          <p>0966 0126231264</p>
                          <p>0966 0126231264</p>
                      </div>
              ...
              <div class="col-xl-6">
                  <div style="border-radius:20px; overflow:hidden;" data-entrance="from-right">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8828.338198583187!2d39.18138550046487!3d21.51324324359736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3d01fb1137e59%3A0xe059579737b118db!2sJeddah%20Saudi%20Arabia!5e0!3m2!1sen!2seg!4v1759687803016!5m2!1sen!2seg" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  </div>

                  <div class="row mt-5 mb-5">
                      <div class="col-xl-6" data-entrance="from-right">
                          <h5 class="bold mb-4">Location</h5>
                          <p>Riyadh: Al Olaya, King Fahd Road</p>
                          <p>Jeddah: Al Sharafiyah – Khalid Bin Al-Walid Street</p>
                      </div>
