...
@section('content')
    ...
    <section class="py-5">
        <div class="container">
            <div class="breadcrumb-container" data-entrance="from-top">
            ...
            @forelse ($service->sections as $section)
                <div class="row mb-5">
                    <div @class(['col-xl-6 mb-4' ,$loop->iteration % 2 == 0 ? 'order-xl-last' : '']) data-entrance="from-top">
                        <img src="{{ asset($section->image) }}" class="w-100 rounded-5" />
                    </div>
                    <div @class(['col-xl-6 mb-4' , $loop->iteration % 2 == 0 ? 'order-xl-first' : '' ]) style="display: flex; flex-direction: column; justify-content: center;" data-entrance="from-top">
                        <p class="font-18 ">
                            {!! $section->body !!}
                        </p>
                    </div>
            ...
            <div class="text-center mt-5" data-entrance="from-top">
