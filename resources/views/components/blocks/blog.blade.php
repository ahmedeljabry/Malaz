<section class="py-5" data-entrance="from-left">
            <div class="container">
                                ...
                                <div class="blog-content">
                                    <div class="d-flex justify-content-between gap-4">
                                        <div>
                                            ...
                                            <div class="blog-description" onclick="window.location.href='{{ route('blog.details' , $post->slug) }}'">
                ...
                <div class="mt-5 text-center">
                    <button class="btn-purple " onclick="window.location.href='{{ route('blog') }}'">
                        <p>{{ __('home.read_more') }}</p>
                    </button>
                </div>
            </div>
    </section>
